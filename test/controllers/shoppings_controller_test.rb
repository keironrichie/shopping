...
class ShoppingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shopping" do
    assert_difference('Shopping.count') do
      post shoppings_url, params: { shopping: { comment: @shopping.comment, item: @shopping.item, quantity: @shopping.quantity, size: @shopping.size } }
    end
  ...
  test "should update shopping" do
    patch shopping_url(@shopping), params: { shopping: { comment: @shopping.comment, item: @shopping.item, quantity: @shopping.quantity, size: @shopping.size } }
